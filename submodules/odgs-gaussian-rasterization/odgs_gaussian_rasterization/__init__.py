...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, depth, acc, radii, psi, lat, lon, geomBuffer, binningBuffer, imgBuffer = _C.rasterize_gaussians(*args)
        ...
        return color, depth, acc, radii, psi, lat, lon

    @staticmethod
    def backward(ctx, grad_out_color, grad_out_depth, grad_out_acc, _r, _p, _lat, _lon):
